/* * A complete tic-tac-toe widget, using JQuery.
  Just include this  * script in a browser page and play.
  A tic-tac-toe game will be  * included as a child element of the element with id "tictactoe".
   * If the page has no such element, it will just be added at the end  * of the body. */
  $(function () {
    var squares = [],
         SIZE = 3,
        EMPTY = "&nbsp;",
...
* To determine a win condition, each square is "tagged" from left
    ...
    set = function () {
        ...
        if (win(score[turn])) {
            alert(turn + " wins! Great job!");
            startNewGame();
        }
 else if (moves === SIZE * SIZE) {
            alert("Cat\u2019s game! Play agian and see who wins!");
            startNewGame();
        }
 else {
            turn = turn === "X" ? "O" : "X";
